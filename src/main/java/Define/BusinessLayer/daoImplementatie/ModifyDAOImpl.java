...
public class ModifyDAOImpl extends DAOFacade {
    ...
    public static String modifyBusinessRule(int ruleId, int rule_type_select, String rule_name, String tableSelect,
        ...
        if (subAttributeId == 0){
            ...
            String updataSubAttribute = "UPDATE TOSAD.ATTRIBUTE SET NAME = ?, TABLENAME = ?, DATABASENAME = ? WHERE ID = " + subAttributeId;
            PreparedStatement stmt = conn.prepareStatement(updataSubAttribute);
//            stmt.setString(1, );
