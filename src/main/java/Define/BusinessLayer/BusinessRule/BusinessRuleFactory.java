...
//
//    BusinessRuleFactory(String ruleName, int compareStatus, int operatorID, List<String> value, int attributeID,
...
//        return new BusinessRule(this.Name, this.CompareStatus, this.OperatorID, this.Value, this.AttributeID,
//                this.SubAttributeID, this.BusinessRuleTypeID);
//    }
//}
