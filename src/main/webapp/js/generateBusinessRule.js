function generateRule() {
    ...
    $.get("generate/generate?array="+jsonArray["id"]+","+jsonArray["name"]+","+jsonArray["comparestatus"]+","+jsonArray["operatorID"]+","+jsonArray["attributeID"]+","+jsonArray["subAttributeID"]+","+jsonArray["businessRuleTypeID"], function(array){
