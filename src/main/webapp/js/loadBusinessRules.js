    ...
    $.get("generate/getBusinessRules/information", function (array) {
        $.each(array, function (i, val) {
            ...
            var promise = new Promise(function (resolve, reject) {
                resolve(getRuleData(val["id"], val["businessRuleTypeID"], val["subAttributeID"]));
            });
            ...
            promise.then(function (successMessage) {
                if(i == 0) {
                    ...
                    console.log(succesMessage[0]);
                    var text = successMessage[0];
                    loadCompareRuleData(array[i], val["id"], val["businessRuleTypeID"], text);
                    ...
                    loadCompareRuleData(array[i], val["id"], val["businessRuleTypeID"], successMessage[0]);
